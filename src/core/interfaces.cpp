...
void CreateInterfaces()
{
    ...
    uintptr_t sig_steamapi = CSignature::GetEngineSignature("55 0F 57 C0 89 E5 83 EC 18 F3 0F 11 05 ? ? ? ? F3 0F 11 05 ? ? ? ? F3 0F 10 05 ? ? ? ? C7 04 24 ? ? ? ? F3 0F 11 05 ? ? ? ? F3 0F 11 05 ? ? ? ? E8 ? ? ? ? C7 44 24 ? ? ? ? ? C7 44 24 ? ? ? ? ? C7 04 24 ? ? ? ? E8 ? ? ? ? C9 C3 90 90 90 90 90 55 0F 57 C0 89 E5 83 EC 28");
    ...
    rg_GlobalVars      = *reinterpret_cast<CGlobalVarsBase ***>(CSignature::GetClientSignature("8B 45 08 8B 15 ? ? ? ? F3 0F 10 88 ? ? ? ?") + 5);
    ...
    g_pUniformStream = **(IUniformRandomStream ***) (CSignature::GetVstdSignature("A3 ? ? ? ? C3 89 F6") + 0x1);
    ...
    g_pScreenSpaceEffects           = **(IScreenSpaceEffectManager ***) (CSignature::GetClientSignature("8D 74 26 00 55 89 E5 57 56 53 83 EC 1C 8B 5D 08 8B 7D 0C 8B 75 10 ") + 0x1c3);
