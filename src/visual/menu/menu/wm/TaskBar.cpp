...
{
static settings::RVariable<rgba_t> color_background{ "zk.style.taskbar.color.background", "232323ff" };
static settings::RVariable<rgba_t> color_border{ "zk.style.taskbar.color.border", "232323ff" };
} // namespace zerokernel_taskbar
