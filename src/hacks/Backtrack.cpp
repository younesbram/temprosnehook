...
void MoveToTick(BacktrackData data)
{
    ...
    static auto hitbox_bone_cache_handle_offset = *(unsigned *) (CSignatures.GetClientSignature("8B 86 ? ? ? ? 89 04 24 E8 ? ? ? ? 85 C0 89 C3 74 48") + 2);
    static auto studio_get_bone_cache           = (GetBoneCache_t) CSignatures.GetClientSignature("55 89 E5 56 53 BB ? ? ? ? 83 EC 50 C7 45 D8");
    static auto bone_cache_update_bones         = (BoneCacheUpdateBones_t) CSignatures.GetClientSignature("55 89 E5 57 31 FF 56 53 83 EC 1C 8B 5D 08 0F B7 53 10");
    ...
    static auto sig_update                     = CSignatures.GetClientSignature("55 89 E5 57 56 53 83 EC 3C 8B 5D ? 8B 43 ? 8B 90");
