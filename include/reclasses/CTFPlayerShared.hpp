...
public:
    ...
    {
        static auto signature = e8call_direct(CSignature::GetClientSignature("E8 ? ? ? ? 84 C0 74 8F"));
    ...
    {                                                         
        static auto signature = CSignature::GetClientSignature("55 89 E5 57 56 53 83 EC 6C 8B 7D ? C7 44 24 ? 0B 00 00 00");
    ...
    {
        static auto signature = CSignature::GetClientSignature("55 89 E5 57 56 53 83 EC 6C C7 45 ? 00 00 00 00 8B 45 ? C7 45 ? 00 00 00 00 8B 98");
