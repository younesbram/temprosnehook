...
#if ENABLE_GLEZ_DRAWING
   glez::preInit();
   fonts::menu.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 10));
   fonts::esp.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 10));
   fonts::center_screen.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 12));
#elif ENABLE_ENGINE_DRAWING
   fonts::menu.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 10, true));
   fonts::esp.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 10, true));
   fonts::center_screen.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 12, true));
#elif ENABLE_IMGUI_DRAWING
   fonts::menu.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 14, true));
   fonts::esp.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 15));
   fonts::center_screen.reset(new fonts::font(paths::getDataPath("/fonts/notosans.ttf"), 15, true));
#endif
#if ENABLE_ENGINE_DRAWING
