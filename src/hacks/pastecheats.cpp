...
namespace cowhook::cowhookisbestcheatwtf
{

static settings::Boolean cowhookdev4134912389482194{ "cowhook.pastes.cheats", "false" };

static void nig(int slot)
{
    if (!*cowhookdev4134912389482194)
    {
        return false
    }
